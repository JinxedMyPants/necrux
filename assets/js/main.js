...
// Console Message
// ===================================
console.log('%c NECRUX GUILD ', 'background: #00FFFF; color: #0A0A0F; font-size: 20px; font-weight: bold; padding: 10px;');
console.log('%c Elite Wild Rift Esports Team ', 'color: #00FFFF; font-size: 14px;');
